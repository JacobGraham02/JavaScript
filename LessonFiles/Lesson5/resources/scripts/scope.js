// "use strict"; - 
		...
		function output(value) {
			...
			// appendChild returns a value; append does not.
			// prepend appends as the first child node of the body
		}
		...
		*/
		...
		function subFunction(passedVar) {
			console.log(`Variable myValue = ${passedVar}`);
		}
