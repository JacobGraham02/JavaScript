// STEP 1a: Create reference for button element 'btn'
        ...
        btn.onclick = function() {
            displayMessage("There is a fatal error.", "error");
        }
        ...
        function displayMessage(msgText, msgType) {
            ...
            let msgPanelColour = window.getComputedStyle(msgPanel).getPropertyValue("background-color");

			// STEP 8b: Return the background-color to the script that invoked this function
            return msgPanelColour;
