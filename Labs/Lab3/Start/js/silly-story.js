...
*/
insertX = ['Donald Trump','Jackie Chan','Santa Claus'];
insertY = ['Area 51, Death Valley','Aruba'];
insertZ = ['spontaneously combused, rapidly sublimated, evaporated instantly'];
// FUNCTIONS
...
function result() {
  ...
  if(document.getElementById("metric").checked) {
		...
		const weight = Math.round(300*0.453592) + ' kgs';
